    ...
    <header className="sticky top-0 z-30 border-b border-slate-200 bg-white/90 backdrop-blur">
      <div className="container-page flex items-center justify-between py-2.5 md:py-3">
        ...
        <nav className="-mx-1 flex items-center gap-1 overflow-x-auto px-1 text-sm text-slate-600 sm:gap-3">
          <Link className="inline-flex shrink-0 items-center gap-1.5 rounded-md px-2 py-1 hover:bg-slate-100 hover:text-[#2badee]" href="/factcards">
            <BookText className="h-4 w-4" />
            <span className="hidden sm:inline">FactCards</span>
          </Link>
          <Link className="inline-flex shrink-0 items-center gap-1.5 rounded-md px-2 py-1 hover:bg-slate-100 hover:text-[#2badee]" href="/picturephrases">
            <ImageIcon className="h-4 w-4" />
            <span className="hidden sm:inline">PicturePhrases</span>
          </Link>
          <Link className="inline-flex shrink-0 items-center gap-1.5 rounded-md px-2 py-1 hover:bg-slate-100 hover:text-[#2badee]" href="/settings">
