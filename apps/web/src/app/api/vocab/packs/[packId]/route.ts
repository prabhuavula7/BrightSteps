...
import { getVocabPackDetails, removeVocabPack, saveVocabPack } from "@/server/vocab/service";
...
export async function PUT(request: Request, context: { params: Promise<{ packId: string }> }) {
  ...
  try {
    ...
    const details = saveVocabPack(packId, body.payload);
